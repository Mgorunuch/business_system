...
<div class="page_info">
    ...
    <div class="container">
        <div class="more_info">
            <span>On this page you can see a lot information about your referrals</span>
        </div>
    </div>
</div>
@endsection
        ...
        <div class="row">
            ...
            <div class="invited-users referal-block">
                <ul class="nav nav-tabs">
                    <li class="nav active"><a href="#tab_user_invites" data-toggle="tab">Your referral invited</a></li>
            ...
            <div class="referal-block withdraw">
                <ul class="nav nav-tabs">
                    @if( \App\InternalTransaction::checkAllowed(true) )<li class="nav"><a href="#tab_internal_transaction" data-toggle="tab">Internal Transaction</a></li>@endif
