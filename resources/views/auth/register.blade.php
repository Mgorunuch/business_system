                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('reffer_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                @if(isset($_GET['ref']))
                                        <input id="reffer_id" type="text" class="form-control" name="reffer_id" readonly value="{{ $_GET['ref'] }}">
                                @else
                                        <input id="reffer_id" type="text" class="form-control" name="reffer_id" value="{{ old('reffer_id') }}">
                                @endif
